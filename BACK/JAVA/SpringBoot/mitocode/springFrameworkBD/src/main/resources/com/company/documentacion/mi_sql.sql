...
-- Volcando datos para la tabla springframework_mitocode_bd.camiseta: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla springframework_mitocode_bd.equipo: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla springframework_mitocode_bd.jugador: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla springframework_mitocode_bd.marca: ~2 rows (aproximadamente)
