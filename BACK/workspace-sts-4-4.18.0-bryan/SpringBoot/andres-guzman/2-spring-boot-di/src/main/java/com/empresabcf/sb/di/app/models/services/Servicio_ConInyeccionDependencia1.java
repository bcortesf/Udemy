...
//@Component(value = "servicioDI1")
//@Service @Qualifier(value = "servicioDI1")

@Service(value = "servicioDI1")
public class Servicio_ConInyeccionDependencia1 implements IServicio {
	
	public Servicio_ConInyeccionDependencia1() {}

	@Override
	public String operacion() {
		StringBuilder rta = new StringBuilder();;
		rta.append("Ejecutando algún proceso importante__conInyeccion#1 + @Qualifier");
		rta.append("<ul>");
	...
	public String getInyeccionDependenciaPorAtributo() {
		return "Inyeccion por 'Atributo' #1";
	}

	@Override
	public String getInyeccionDependenciaPorSetter() {
		return "Inyeccion por 'MetodoSet' #1";
	}

	@Override
	public String getInyeccionDependenciaPorConstructor() {
		return "Inyeccion por 'Constructor' #1";
	}
